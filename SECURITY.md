...
- [Community review packet](docs/security/community-review-packet.md) pins an independent-review scope and defines the evidence required before the review can be called complete.
