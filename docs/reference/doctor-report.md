...
- Cloudflare collectorはWorker settingsのsecret binding名からpresenceだけを導出し、値を保持しません。
...
# cwd: repository root
# expected-exit: 1
ext doctor --cloudflare --worker tenantscript-control-plane --database-id 123e4567-e89b-12d3-a456-426614174000 --runtime cloudflare-workers
```
