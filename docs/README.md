...
- **Repository verified / Blocked** — [Slack OAuth v2 exchange boundary](operations/slack-oauth-exchange.md)で、固定originのcode交換contractと未実装のHTTP/session/live境界を区別できます。
