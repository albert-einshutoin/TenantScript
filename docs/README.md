...
- **Repository verified / Blocked** — [Plugin authoring eval contract](reference/plugin-authoring-evals.md)で、10件の固定corpus、決定論的judge、pass@1と失敗分類を検証できます。実agentのisolated runnerと外部agent計測は未実装です。
